...
def check():
	...
	target_count = flask.session.get("target_count")
	...
	# Cool, they found a new word
		...
		rslt = {"check": True, "matches": len(matches), "target_count": target_count}

	elif text in matches:
		string = "You already found {}".format(text)
		rslt = {"check": string, "matches": len(matches), "target_count": target_count}

	elif not in_jumble:
		string = '"{}" can\'t be made from the letters {}'.format(text, jumble)
		rslt = {"check": string, "matches": len(matches), "target_count": target_count}

	elif not matched:
		string = "{} isn't in the list of words".format(text)
		rslt = {"check": string, "matches": len(matches), "target_count": target_count}

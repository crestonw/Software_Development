...
def respond(sock):
    ...
    p = "/Users/crestonw/Documents/GitHub/proj1-pageserver/pages" + parts[1]
    log.info(parts[1])
    li = ["~", "//", ".."]
    ...
    if len(parts) > 1 and parts[0] == "GET":
        try:
            ...
            if (li[0] in parts[1]) or (li[1] in parts[1]) or (li[2] in parts[1]):
                transmit(STATUS_FORBIDDEN, sock)
            
            elif os.path.isfile(p) and parts[1].endswith(('.html','.css')):
